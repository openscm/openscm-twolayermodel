...
project = "OpenSCM Two Layer Model"
...
autodocgen_config = [
    {
        ...
        if modulename == "openscm_twolayermodel"
        else modulename,
    }
]
...
html_theme_options = {
    "repository_url": "https://github.com/openscm/openscm-twolayermodel",
